...
m <- rbind(c("Qualitative", "bright",           "7 (3)", "no"),
           c("Qualitative", "high-contrast",    "5 (5)", "no"),
...
```{r qualitative, fig.height=7, fig.show="hold", fig.cap="Qualitative color schemes", alt.text="Qualitative color schemes"}
...
```{r sequential, fig.height=7, fig.show="hold", fig.cap="Sequential color schemes", alt.text="Sequential color schemes"}
op <- graphics::par(mfrow = c(7, 1), oma = c(0, 0, 0, 0))
...
```{r ylorbr, fig.height=4, fig.show="hold", fig.cap="Prepare YlOrBr scheme for gray-scale conversion.", alt.text="Prepare YlOrBr scheme for gray-scale conversion."}
op <- graphics::par(mfrow = c(4, 1), oma = c(0, 0, 0, 0))
